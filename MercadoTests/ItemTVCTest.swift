...
class ItemTVCTest: XCTestCase {
    
    var tvc:ItemTableViewController! = nil
    let nameCntr = "ItemTableViewController"
    
    override func setUp() {
        super.setUp()
        tvc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: nameCntr) as! ItemTableViewController
        _ = tvc.view
    }
